const doctype = "sql purchase invoice";
const updateMethod = "sql_accounting_software.sql_accounting_software.doctype.sql_purchase_invoice.sql_purchase_invoice_list.update";
