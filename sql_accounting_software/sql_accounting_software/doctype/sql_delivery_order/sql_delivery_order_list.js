const doctype = "sql delivery order";
const updateMethod = "sql_accounting_software.sql_accounting_software.doctype.sql_delivery_order.sql_delivery_order_list.update";
