const doctype = "customer invoice";
const updateMethod = "sql_accounting_software.sql_accounting_software.doctype.customer_invoice.customer_invoice_list.update";
