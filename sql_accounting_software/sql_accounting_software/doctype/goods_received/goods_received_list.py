...
DOCTYPE_URL_NAME = "PH_GR"
ERP_PRIMARY_KEY = "gr_no"
...
def match_erp_with_api_json(data):
    ...
    "net_total":  data.get("DOCAMT"),
    "deposit_amount":  data.get("D_AMOUNT"),
    "local_net_total":  data.get("LOCALDOCAMT"),
    "landing_cost_1":  data.get("LANDINGCOST1"),
    "landing_cost_2":  data.get("LANDINGCOST2"),
	}
	return output_data
