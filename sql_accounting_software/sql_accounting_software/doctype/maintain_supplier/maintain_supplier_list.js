const doctype = "maintain supplier";
const updateMethod = "sql_accounting_software.sql_accounting_software.doctype.maintain_supplier.maintain_supplier_list.update";
