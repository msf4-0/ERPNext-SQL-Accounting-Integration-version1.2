const doctype = "supplier payment";
const updateMethod = "sql_accounting_software.sql_accounting_software.doctype.supplier_payment.supplier_payment_list.update";
