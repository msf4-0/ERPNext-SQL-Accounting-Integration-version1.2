const doctype = "maintain customer";
const updateMethod = "sql_accounting_software.sql_accounting_software.doctype.maintain_customer.maintain_customer_list.update";
