const doctype = "customer debit note";
const updateMethod = "sql_accounting_software.sql_accounting_software.doctype.customer_debit_note.customer_debit_note_list.update";
