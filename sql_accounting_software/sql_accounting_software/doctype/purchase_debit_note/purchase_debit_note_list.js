const doctype = "purchase debit note";
const updateMethod = "sql_accounting_software.sql_accounting_software.doctype.purchase_debit_note.purchase_debit_note_list.update";
