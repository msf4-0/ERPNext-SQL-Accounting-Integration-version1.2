const doctype = "supplier credit note";
const updateMethod = "sql_accounting_software.sql_accounting_software.doctype.supplier_credit_note.supplier_credit_note_list.update";
