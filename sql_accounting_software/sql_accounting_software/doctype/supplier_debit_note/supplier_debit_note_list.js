const doctype = "supplier debit note";
const updateMethod = "sql_accounting_software.sql_accounting_software.doctype.supplier_debit_note.supplier_debit_note_list.update";
