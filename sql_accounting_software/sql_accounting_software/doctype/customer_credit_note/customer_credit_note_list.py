...
DOCTYPE = "customer credit note"
DOCTYPE_URL_NAME = "AR_CN"
ERP_PRIMARY_KEY = "cn_no"
...
def match_erp_with_api_json(data):
	...
	output_data = {
    "cn_no":  data.get("DOCNO"),
    "customer_code":  data.get("CODE"),
    "area":  data.get("AREA"),
    "agent":  data.get("AGENT"),
    "cn_description":  data.get("DESCRIPTION"),
    # "customer":  data.get("TERMS"),
    ...
    # "bill_to":  data.get("P_PAYMENTMETHOD"),
