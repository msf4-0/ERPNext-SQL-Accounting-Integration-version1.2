const doctype = "customer credit note";
const updateMethod = "sql_accounting_software.sql_accounting_software.doctype.customer_credit_note.customer_credit_note_list.update";
