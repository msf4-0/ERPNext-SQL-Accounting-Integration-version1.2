const doctype = "maintain stock item";
const updateMethod = "sql_accounting_software.sql_accounting_software.doctype.maintain_stock_item.maintain_stock_item_list.update";
