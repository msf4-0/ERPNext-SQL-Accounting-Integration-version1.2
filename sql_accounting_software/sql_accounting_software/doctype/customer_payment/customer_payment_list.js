const doctype = "customer payment";
const updateMethod = "sql_accounting_software.sql_accounting_software.doctype.customer_payment.customer_payment_list.update";
