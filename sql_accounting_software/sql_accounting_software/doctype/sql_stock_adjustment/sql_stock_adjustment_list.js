const doctype = "sql stock adjustment";
const updateMethod = "sql_accounting_software.sql_accounting_software.doctype.sql_stock_adjustment.sql_stock_adjustment_list.update";
