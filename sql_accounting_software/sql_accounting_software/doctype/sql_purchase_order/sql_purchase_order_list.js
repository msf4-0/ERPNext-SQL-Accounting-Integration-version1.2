const doctype = "sql purchase order";
const updateMethod = "sql_accounting_software.sql_accounting_software.doctype.sql_purchase_order.sql_purchase_order_list.update";
